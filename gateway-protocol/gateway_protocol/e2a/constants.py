...
"""E2A 出处常量与 ACP 方法名 / SessionUpdate 判别式（协议说明见 ``docs/{zh,en}/E2A-protocol.md``）。"""
...
# E2AResponse.status（协议说明见 docs/zh/E2A-protocol.md）
...
# 运行时以本元组为准（协议说明见 docs/zh/E2A-protocol.md）
