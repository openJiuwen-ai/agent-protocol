...
protected:
    ...
    {
        return [expectedContent](const std::string& uri) {
            ReadResourceResult result;
            TextResourceContents contents;
            contents.uri = uri;
...
TEST_F(ResourceManagerTest, ReadResource_Success)
{
    ...
    auto readFunc = [expectedContent](const std::string& uri) {
        ReadResourceResult result;
        TextResourceContents contents;
        contents.uri = uri;
        contents.text = expectedContent;
...
TEST_F(ResourceManagerTest, ReadResource_BlobResource)
{
    ...
    auto readFunc = [](const std::string& uri) {
        ReadResourceResult result;
...
TEST_F(ResourceManagerTest, ReadResource_HandlerReceivesCorrectUri)
{
    ...
    auto readFunc = [&receivedUri](const std::string& uri) {
        receivedUri = uri;
