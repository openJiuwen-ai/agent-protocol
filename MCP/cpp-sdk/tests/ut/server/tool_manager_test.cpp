...
static ToolReturn TestToolFunc(const ServerContext& /* ctx */, const std::string& name,
...
static ToolReturn TestCallbackToolFunc(const ServerContext& /* ctx */, const std::string& name,
    const std::string& arguments)
{
    (void)arguments;
...
protected:
    ...
    {
        auto errorFunc = [](const ServerContext& /* ctx */, const std::string& name, const std::string& arguments)
            -> ToolReturn {
            (void)arguments;
...
static ToolReturn StructuredOutputToolFunc(const ServerContext& /* ctx */, const std::string& name,
    const std::string& arguments)
{
    (void)name;
...
static ToolReturn ErrorResultToolFunc(const ServerContext& /* ctx */, const std::string& name,
    const std::string& arguments)
{
    (void)name;
    (void)arguments;
...
{
    auto arrayFunc = [](const ServerContext&, const std::string&, const std::string&) -> ToolReturn {
        return R"([1, 2, 3])";
    };
...
{
    auto noStructuredFunc = [](const ServerContext&, const std::string&, const std::string&) -> ToolReturn {
        CallToolResult result;
        TextContent text;
