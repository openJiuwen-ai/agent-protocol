...
private:
    ...
    static Mcp::ReadResourceFunc CreateReadResourceFunction() {
        return [](const Mcp::ServerContext & /* ctx */, const std::string &uri) -> Mcp::ReadResourceResult {
    ...
    static std::function<Mcp::GetPromptResult(const Mcp::ServerContext &, const std::string&,
                                              const std::optional<std::string>&)>
    CreatePromptFunction() {
        return [](const Mcp::ServerContext & /* ctx */, const std::string &promptName,
