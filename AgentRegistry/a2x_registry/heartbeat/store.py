...
NOTE: ``NodeHeartbeatStore`` (appliance-mode per-node variant) was
removed together with the node heartbeat endpoints —
instance liveness is now reported by the gateway via PATCH status.
"""
