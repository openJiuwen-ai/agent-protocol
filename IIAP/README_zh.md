...
- [SDK 设计文档](docs/zh/sdk-design/README.md)
- [SDK 集成文档](docs/zh/sdk-integration/README.md)
...
- 源码逻辑模块：正式支持的 A2UI v0.8 Adapter 与未发布的 v0.9.1 实验源码位于 `adapters/`，HTTP Transport 位于 `transports/http`，可选 React Presenter 位于 `presenters/react`
