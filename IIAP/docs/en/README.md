...
The machine-readable JSON Schemas under `contracts/schemas/` are the wire
contract. The detailed architecture and integration references are currently
maintained in [Chinese](../zh/README.md).
